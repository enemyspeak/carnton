...
local audio =	{
				andantino = love.audio.newSource("res/Andantino.ogg","streaming") -- if "static" is omitted, LÖVE will stream the file from disk --.mp3 playback buggy, .ogg recommended
				}
...
local image1 = love.graphics.newImage('res/8.jpg')	
local image3 = love.graphics.newImage('res/3.jpg')	
local image4 = love.graphics.newImage('res/9.jpg')	--4
local image5 = love.graphics.newImage('res/10.jpg')	
local image6 = love.graphics.newImage('res/9.jpg')	
local image7 = love.graphics.newImage('res/7.jpg')	

local transition1 = love.graphics.newImage('res/trans/8.jpg')	
local transition3 = love.graphics.newImage('res/trans/3.jpg')	
local transition4 = love.graphics.newImage('res/trans/9.jpg')	--4
local transition5 = love.graphics.newImage('res/trans/10.jpg')	
local transition6 = love.graphics.newImage('res/trans/9.jpg')	
...
--	duration = 1
	...
	audio["andantino"]:setVolume( 1 ) -- % of ordinary volume
	audio["andantino"]:setLooping( true )
	love.audio.setVolume( 1 )
	love.audio.play(audio["andantino"])
...
function Two:draw()
	...
	if t > duration and not buttonPressed then
...
function Two:joystickpressed(joystick, button)
